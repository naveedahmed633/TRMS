...
function populateDropDowns() {
    // fetch shifts first
    CalendarUtils.getGeneralShifts("/LM/ShiftManagement/getShiftsForGeneralCalendar", function (shifts) {
...
function setSubmitButtonAction() {
    ...
    $('#submit_calendar_button').on("click", function (e) {
        ...
        CalendarUtils.submitGeneralCalendar(calendarData, "/LM/ShiftManagement/addOrUpdateCalendar");
