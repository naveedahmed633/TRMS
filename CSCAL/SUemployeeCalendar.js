...
CalendarUtils =
    {
        submitEmployeeCalendar: function () {
            ...
            $.ajax({
                ...
                type: 'POST',
                url: "/SuperAdmin/ManageEmployees/addOrUpdateEmpCalendar",
                data: JSON.stringify({
        ...
        /*getGeneralCalendar('2014', 'http://localhost:57588/SuperAdmin/ManageEmployees/getCalendarForYear', function (calendar) {
            console.log(calendar);
        });*/
        getGeneralCalendar: function (yearForCalendar, calendarURL, callback) {
            
            var value = $('#group').val();
            console.log("I love Django : "+value);
            console.log("goining to call get calender for year api",yearForCalendar);
            $.ajax({
                type: 'POST',
                url: calendarURL,
                data: {
        ...
        /*
        getGeneralShifts("http://localhost:57588/SuperAdmin/ManageEmployees/getShiftsForGeneralCalendar",function (shifts) {
          console.log(shifts);
        });
        */
        getGeneralShifts: function (shiftsURL, callback) {
            var value = $('#group').val();
            console.log("here is i am where is you   :" + value);
            var val = { group_id: value };
            $.ajax({
                type: 'POST',
                url: shiftsURL,
                data: val,
...
function initEditDayModal(parentDivIdentifier) {
    ...
    function onClickDone() {
        ...
        for (var i = 0; i < employeeCalendarOverrides.length; i++) {
            if (employeeCalendarOverrides[i].date == editDayFormDate) {
...
function initializeTimeTuneGeneralCalendar() {
    ...
    $.fn.calendar().__proto__._render = function () {
        ...
        CalendarUtils.getGeneralCalendar(calendarData.year, '/SuperAdmin/ManageEmployees/getGeneralCalendarForYearEmployee', function (calendar) {
...
function loadShifts() {
    ...
    $('#toast').fadeIn(400);
    // fetch shifts first
    CalendarUtils.getGeneralShifts("/SuperAdmin/ManageEmployees/getShiftsForGeneralCalendar", function (shifts) {
...
function loadEmployeeCalendar() {
    if (typeof SELECTED_EMPLOYEE != 'undefined') {
        $.ajax({
            type: 'POST',
            url: "/SuperAdmin/ManageEmployees/getEmployeeCalendar",
            data: {
                employee_id: SELECTED_EMPLOYEE,
