...
function populateDropDowns() {
    ...
    CalendarUtils.getGeneralShifts("/SuperAdmin/ManageEmployees/getShiftsForGeneralCalendar", function (shifts) {
        ...
        if (shifts.length == 0) {
            $('#calendar_edit_form').hide();
            alert("TimeTune: Your group has not been assigned any shifts, please contact HR.");
            return;
        }
...
function initializeTimeTuneGeneralCalendar() {
    ...
    $.fn.calendar().__proto__._render = function () {
        ...
        CalendarUtils.getGeneralCalendar(calendarData.year, '/SuperAdmin/ManageEmployees/getGeneralCalendarForYear', function (calendar) {
...
function initEditDayModal(parentDivIdentifier) {
    ...
    toReturn = function (dayElement) {
        ...
        editDayFormType = "none";
        editDayFormDate = convertMonthNameToNumber(month) + "/" + day + "/" + year;
...
function setSubmitButtonAction() {
    ...
    $('#submit_calendar_button').on("click", function (e) {
        ...
        CalendarUtils.submitGeneralCalendar(calendarData, "/SuperAdmin/ManageEmployees/addOrUpdateCalendar");
