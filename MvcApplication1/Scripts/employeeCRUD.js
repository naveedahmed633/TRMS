...
function initEditEmployeeModal(updateURL) {
    ...
    var selectPosition = $('#modal_position');
    var selectSite = $('#modal_site');

    var ddlSickLeaves = $('#modal_sick_leaves');
    var ddlCasualLeaves = $('#modal_casual_leaves');
    var ddlAnnualLeaves = $('#modal_annual_leaves');
    var ddlOtherLeaves = $('#modal_other_leaves');
    var ddlLeaveType01 = $('#modal_leave_type01');
    var ddlLeaveType02 = $('#modal_leave_type02');
    var ddlLeaveType03 = $('#modal_leave_type03');
    var ddlLeaveType04 = $('#modal_leave_type04');
    var ddlLeaveType05 = $('#modal_leave_type05');
    var ddlLeaveType06 = $('#modal_leave_type06');
    var ddlLeaveType07 = $('#modal_leave_type07');
    var ddlLeaveType08 = $('#modal_leave_type08');
    var ddlLeaveType09 = $('#modal_leave_type09');
    var ddlLeaveType10 = $('#modal_leave_type10');
    var ddlLeaveType11 = $('#modal_leave_type11');
   ...
   .add(fieldSkillSet);
    ...
    function updateItem() {
        ...
        var valid = true;
        valid = valid && checkLength(fieldEmployeeCode, "Employee Code", 1, 15);
        ...
        if (valid) {
            ...
            $.ajax({
                ...
                data: {
                    id: rowBeingEdited,
                    campus_id: selectCampus.val(),
                    pshift_id: selectPShift.val(),
                    first_name: fieldFirstname.val(),
                    last_name: fieldLastname.val(),
                    father_name: fieldFathername.val(),
                    gender_id: selectGender.val(),
                    employee_code: fieldEmployeeCode.val(),
                    cnic_no: fieldCNICNo.val(),
                    ...
                    position_id: selectPosition.val(),
                    site_id: selectSite.val(),
                    sick_leaves: ddlSickLeaves.val(),
                    casual_leaves: ddlCasualLeaves.val(),
                    annual_leaves: ddlAnnualLeaves.val(),
                    other_leaves: ddlOtherLeaves.val(),
                    leave_type01: ddlLeaveType01.val(),
                    leave_type02: ddlLeaveType02.val(),
                    leave_type03: ddlLeaveType03.val(),
                    leave_type04: ddlLeaveType04.val(),
                    leave_type05: ddlLeaveType05.val(),
                    leave_type06: ddlLeaveType06.val(),
                    leave_type07: ddlLeaveType07.val(),
                    leave_type08: ddlLeaveType08.val(),
                    leave_type09: ddlLeaveType09.val(),
                    leave_type10: ddlLeaveType10.val(),
                    leave_type11: ddlLeaveType11.val(),
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                if (data.success) {
                    ...
                    fieldFathername.val(data.father_name);
                    //fieldGendername.val(data.gender_name);
                    fieldEmployeeCode.val(data.employee_code);
                    fieldCNICNo.val(data.cnic_no);
                    ...
                    ddlOtherLeaves.val(data.other_leaves);
                    ddlLeaveType01.val(data.leave_type01);
                    ddlLeaveType02.val(data.leave_type02);
                    ddlLeaveType03.val(data.leave_type03);
                    ddlLeaveType04.val(data.leave_type04);
                    ddlLeaveType05.val(data.leave_type05);
                    ddlLeaveType06.val(data.leave_type06);
                    ddlLeaveType07.val(data.leave_type07);
                    ddlLeaveType08.val(data.leave_type08);
                    ddlLeaveType09.val(data.leave_type09);
                    ddlLeaveType10.val(data.leave_type10);
                    ddlLeaveType11.val(data.leave_type11);
                    ...
                    function setDropDownVal3(dropDown, id, name) {
                        if (name == null || id == null) {
                            return;
                        }
                        //alert(name);
                        ...
                        if (name == "male") {
                            ...
                            dropDown.append("<option value='1'>Male</option>");
                        }
                        else if (name == "female") {

                            dropDown.append("<option value='2'>Female</option>");
                        }
                        else {
                    ...
                    setDropDownVal(selectCampus, data.campus_id, data.campus_name);
                    setDropDownVal(selectPShift, data.pshift_id, data.pshift_name);
                    ...
                    setDropDownVal(selectPosition, data.position_id, data.position_name);
                    setDropDownVal(selectSite, data.site_id, data.site_name);
                    ...
                    setDropDownVal3(selectGender, data.gender_id, data.gender_name);
