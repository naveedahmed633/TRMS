...
(function ($) {
    ...
    $.fn.ajaxChosen = function (ajaxOptions, options, chosenOptions) {
        ...
        if (typeof chosenOptions === 'undefined') { //if (chosenOptions == undefined) {
            chosenOptions = {
                search_contains: true
            };

            //alert(JSON.stringify(chosenOptions));
        }
        /*
        {
            search_contains: true
        ...
        */
        ...
        if ('throttleMs' in options && typeof options.throttleMs === 'number') {
            throttleDelay = options.throttleMs;
        }
