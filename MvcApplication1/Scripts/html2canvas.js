        ...
        var CanvasRenderer = function () {
            ...
            _createClass(CanvasRenderer, [{
                ...
                value: function render(options) {
                    ...
                    this.canvas.style.width = 780 + 'px';
                    this.canvas.style.height = 300 + 'px';
                    //console.log(this.options.scale+ "test");
                ...
                value: function drawImage(image, source, destination) {
                    this.ctx.drawImage(image, source.left, source.top, 780, 300, destination.left, destination.top, 780, 300);
                }
            }, {
                key: 'drawShape',
