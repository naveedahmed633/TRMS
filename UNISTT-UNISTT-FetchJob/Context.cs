...
namespace UNISTT_UNISTT_FetchJob
{
    ...
    {
        //public static string connectionString = ConfigurationManager.ConnectionStrings["UNISTimeTuneRegion"].ConnectionString;
        public static string connectionStringUTRegion = ConfigurationManager.ConnectionStrings["UNISTimeTuneRegion"].ConnectionString;

        public Context()
            : base(connectionStringUTRegion)
        {
    ...
    {
        //public static string connectionString = ConfigurationManager.ConnectionStrings["UNISTimeTuneMaster"].ConnectionString;
        public static string connectionStringUTMaster = ConfigurationManager.ConnectionStrings["UNISTimeTuneMaster"].ConnectionString;

        public ContextMaster()
            : base(connectionStringUTMaster)
        {
            // : base("Server=10.200.65.194; Database=TimeTune; User Id=sa; Password=resco123!!")
            //public Context():base("Server=192.168.0.229; Database=TimeTune; User Id=sa; Password=mngr")
            //this.Configuration.LazyLoadingEnabled = true;
