...
namespace ViewModels
{
     ...
     * and absent report
     */
    public class OrganizationPaAttendanceLog
    {
        [Key]
    ...
    public class OrganizationPayrollReportByMonthLog
    {
        [Key]
        public int Id { get; set; }
    ...
    public class OrganizationLoanReportByMonthLog
    {
        [Key]
        public int Id { get; set; }
    ...
    */
    public class OrganizationMonthlyTimesheetAttendanceLog
    {
        [Key]
        public int id { get; set; }
        public string date { get; set; }
    ...
    *The View Model contains all attribute that will show on report page
    */
    public class OrganizationConsolidatedAttendanceLog
    {
        [Key]
        public int id { get; set; }
        public string date { get; set; }
    ...
    public class OrganizationConsolidatedAttendanceArchiveLog
    {
        [Key]
        public int id { get; set; }
    ...
    public class OrganizationDepartmentAttendanceCountReport
    {
        [Key]
        public int EmployeeId { get; set; }
        public string EmployeeCode { get; set; }
    ...
    public class OrganizationConsolidatedAttendanceDepartmentWise
    {
        [Key]
        public int id { get; set; }
        public string date { get; set; }
    ...
    public class OrganizationConsolidatedAttendanceDepartmentWiseExcelDownload
    {
        public string Date { get; set; }
        public string Employee_Code { get; set; }
    ...
    public class OrganizationConsolidatedAttendanceExport
    {
        public string Date { get; set; }
    ...
    public class OrganizationHourlyAttendanceExport
    {
        public string Date { get; set; }
        public string Employee_Number { get; set; }
        public string First_Name { get; set; }
    ...
    public class OrganizationConsolidatedAttendanceLogIntermediate
    {
        [Key]
        public int id { get; set; }
    ...
    public class OrganizationHaTransitsUniqueAttendanceLog
    {
        [Key]
    ...
    public class OrganizationConsolidatedAttendanceExportOvertime
    {
        public string Date { get; set; }
        public string Employee_Number { get; set; }
        public string First_Name { get; set; }
    ...
    public class OrganizationLeavesReportByUserLog
    {
        [Key]
        public int Id { get; set; }
        public int EmployeeId { get; set; }
    ...
    public class OrganizationLeavesReportByUserLogIntermediate
    {
        [Key]
        public int Id { get; set; }
        public int EmployeeId { get; set; }
    ...
    public class OrganizationLeavesCountReportLog
    {
        [Key]
        public int id { get; set; }
        public int EmployeeId { get; set; }
    ...
    public class OrganizationLeavesBalanceReportLog
    {
        [Key]
        public int id { get; set; }
        public int EmployeeId { get; set; }
    ...
    public class OrganizationLeavesListCount
    {
        public int list_count { get; set; }
    }


    public class OrganizationLeavesListReportLog
    {
        [Key]
        public int id { get; set; }
        public int EmployeeId { get; set; }
    ...
    public class OrganizationLoanReportByMonthLogIntermediate
    {
        [Key]
        public int Id { get; set; }
    ...
    public class OrganizationPayrollReportByMonthLogIntermediate
    {
        [Key]
        public int Id { get; set; }
    ...
    public class OrganizationMonthlyTimesheetAttendanceLogIntermediate
    {
        [Key]
        public int id { get; set; }
        public DateTime? date { get; set; }
    ...
    public class OrganizationConsolidatedAttendanceLogIntermediateDepartmentWise
    {
        [Key]
        public int id { get; set; }
        public DateTime? date { get; set; }
    ...
    public class OrganizationPaAttendanceLogIntermediate
    {
        [Key]
        public int id { get; set; }
        public DateTime? date { get; set; }
